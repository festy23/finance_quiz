...
export const questions = [
  ...
  {
    id: "ap11", topic: "approx", difficulty: 2,
    q: "Чем абсолютное отклонение приближённого решения отличается от относительного?",
    options: [
      "Абсолютное — это $|ALG-OPT|$; относительное — то же, делённое на $OPT$ (доля от оптимума)",
      "Абсолютное считают для минимизации, а относительное — исключительно для задач максимизации",
      "Абсолютное отклонение всегда полиномиально, а относительное — всегда экспоненциально по входу",
      "Это два равнозначных названия коэффициента $\\rho$, всегда совпадающие по числовому значению",
    ],
    correct: [0], multi: false,
    explain: "Абсолютное отклонение $|ALG-OPT|$ измеряется в единицах целевой функции и плохо масштабируется. Относительное $|ALG-OPT|/OPT$ безразмерно и связано с коэффициентом $\\rho$: именно его гарантируют схемы PTAS/FPTAS.",
  },
]
